...
const SignupPage = () => {
  ...
  return (
    <div>
      <div className="w-full max-w-md mx-auto my-10 p-8 space-y-3 rounded-xl shadow-2xl dark:bg-gray-50 dark:text-gray-800">
        ...
        <p className="text-center sm:px-6 dark:text-gray-600">
          ...
          <a
            ...
            href="#"
            className="underline hover:text-red-600 dark:text-gray-800"
          >
            Sign In
          </a>
        </p>
